...
// See https://github.com/PrismJS/prism/pull/1367
    ...
    Compiler.prototype._initRenderer = function _initRenderer() {
        ...
        origin.heading = renderer.heading = function (text, level) {
            ...
            console.log(str+", url:"+url+", docsify:" + window.$docsify);
        ...
        origin.link = renderer.link = function (href, title, text) {
            ...
            if(window.$docsify !== void 0 && window.$docsify.castomClass !== void 0) {
                for(var a in window.$docsify.castomClass) {
                    if(text.indexOf(a) >= 0) {
                        attrs += " class=\"" + window.$docsify.castomClass[a] + "\"";
                    }
                }
            }
        ...
        origin.image = renderer.image = function (href, title, text) {
            ...
            if (!isAbsolutePath(href)) {
                var basePath = contentBase;
                var parentPath = getParentPath(router.getCurrentPath());
                url = router.getFile(parentPath + href, true);
                console.log("Get picture path: " + url);
//                if(parentPath !== '/') {
...
//                    parentPath = '/';
//                }
//                url = getPath(basePath, parentPath, href);
            }
    ...
    History.prototype.getFile = function getFile(path, isRelative) {
        ...
        var ext = (path.match(/\.[0-9a-z]+$/i))
            ? '' : (typeof config.ext === 'string') ? config.ext : '.md';
